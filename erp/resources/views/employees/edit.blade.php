        ...
        <div class="flex items-center justify-between mb-8">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="text-gray-600 dark:text-gray-300 mt-1">Update {{ $employee->first_name }} {{ $employee->last_name }}'s information</p>
                </div>
            </div>
        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" id="salary" name="salary" value="{{ old('salary', $employee->salary) }}" required step="0.01" min="0"
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                    ...
                    <div class="p-6">
                        <div id="qualifications-container">
                            @php
                                $qualifications = old('qualifications', $employee->qualifications ?: ['']);
